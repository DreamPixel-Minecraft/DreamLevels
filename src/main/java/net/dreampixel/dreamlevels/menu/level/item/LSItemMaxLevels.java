...
public class LSItemMaxLevels extends MenuItem {
    private final LevelModificationMenu menu;
    private final Level level;

    private ItemMeta originalMeta;

    public LSItemMaxLevels(LevelModificationMenu menu) {
        super(Objects.requireNonNull(LevelSpyManager.getInstance().getItemByKey("max-levels")));
        this.menu = menu;
    ...
    public Object getDisplayValue() {
        return level.getDefaultMaxLevels();
    }
}
