...
public class LSItemRequiredExp extends MenuItem {
    private final LevelModificationMenu menu;
    private final Level level;

    private ItemMeta originalMeta;

    public LSItemRequiredExp(LevelModificationMenu menu) {
        super(Objects.requireNonNull(LevelSpyManager.getInstance().getItemByKey("required-exp")));
        this.menu = menu;
    ...
    public void updateItem() {
        ...
        setItemMeta(meta);
        menu.setItem(1, 13, this);
    }

    @NotNull
    public Object getDisplayValue() {
        return level.getDefaultRequiredExp();
    }
}
